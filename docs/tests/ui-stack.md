...
| 检查 ADR | `test -f docs/decisions/ui-stack-flexibility.md` | 文件存在 | 静态检查 |
...
test -f docs/decisions/ui-stack-flexibility.md
```
...
- 实际结果：
  ...
  - `test -f docs/decisions/ui-stack-flexibility.md` 已执行，文件存在。

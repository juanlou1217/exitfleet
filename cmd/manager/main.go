...
func main() {
	...
	mgr := manager.New(manager.Options{
		...
		Launcher: workerdocker.NewLauncher(workerdocker.Config{
			...
			WorkerProxyOutboundIP:       workerCfg.ProxyOutboundIP,
			WorkerSOCKSMaxConnections:   workerCfg.SOCKSMaxConnections,
			WorkerHealthHost:            workerCfg.HealthHost,
			WorkerHealthPort:            workerCfg.HealthPort,
			WorkerHealthURLs:            workerCfg.HealthURLs,
			WorkerHealthFailThreshold:   workerCfg.HealthFailThreshold,
			WorkerHealthIntervalSeconds: workerCfg.HealthIntervalSeconds,
			WorkerHealthTimeoutSeconds:  workerCfg.HealthTimeoutSeconds,
